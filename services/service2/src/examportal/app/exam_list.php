...
<head>
    ...
    <title>ExamPortal - Exam list</title>
</head>
    ...
    <div class="container my-5">
        ...
        <div class="row justify-content-center mt-3">
            <div class="col-12 col-md-8  py-3 border rounded bg-primary text-white">
                ...
                <h3><i class="fa-solid fa-list-check"></i> Exam lists</h3>
                <div class="list-group" style="max-height: 500px;overflow-y: auto;">
                    <?
                    foreach ($exams as $i => $exam) {
                        $id = $exam["id"];
                        $name = $exam["name"];
                        echo "<a class='list-group-item list-group-item-action' href='/exam.php?id=$id'><i class='fa-solid fa-file-lines'></i> $name</a>\n";
                    }
                    ?>
                </div>
